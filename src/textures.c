...
/*   Updated: 2023/02/23 13:04:37 by gcherqui         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_texture_t* texture_p = mlx_load_png("./textures/parametres.png");
	mlx_image_t* img_p = mlx_texture_to_image(caca->mlx, texture_p);
